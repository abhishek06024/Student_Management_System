...
if(isset($_POST['search'])){
  ...
  $query =" SELECT * from first_year_students where Board_Roll_No like '%$box%' or email like '%$box%' or first_name like '%$box%' or last_name like '%$box%' or father_name like '%$box%' or branch like '%$box%' or status like '%$box%' or sem like '%$box%' order by Board_Roll_No ASC";
...
//   print_r($data);die();
  ...
  { 
    $count=1;
     ...
     {
    $query1="SELECT * FROM final_year_students  ORDER BY Board_Roll_No ASC WHERE status=Passout";
