...
<body>
  ...
  if(isset($_POST['search'])){
    ...
    $query =" SELECT * from second_year_students where Board_Roll_No like '%$box%' or email like '%$box%' or mobile like '%$box%' or first_name like '%$box%' or last_name like '%$box%' or father_name like '%$box%' or branch like '%$box%' or status like '%$box%' or sem like '%$box%' order by Sr_No ASC";
    ...
    $query="SELECT * FROM second_year_students ORDER BY Sr_No ASC";
    $data= mysqli_query($connection,$query);
