...
if(!$connection)
{
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        $check="SELECT * from admin where email like'%$email%' or phone like '%$phone%'";
        ...
        $query= "INSERT INTO `teachers` ( `first_name`, `last_name`, `email`, `password`, `cnf_password`, `phone`, `designation`, `department`, `gender`, `admin_image`) VALUES ('$first_name', '$last_name', '$email', '$pass', '$cword','$phone','$designation','$department','$gender','$folder')";
        // print_r($query);
        // die();
